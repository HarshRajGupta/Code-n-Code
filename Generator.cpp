...
#define pr (1ll * (rand() % primes[rand() % primes.size()]) * (rand() % primes[rand() % primes.size()])) % primes[rand() % primes.size()]
...
class Solution : private testCase {
    void generateTestCase(void) {
        /* generate test case */
        std::cout <<  (1ll * (rand() % primes[rand() % primes.size()]) * (rand() % primes[rand() % primes.size()])) % primes[rand() % primes.size()] << ' '  << rand() << '\n';
        // std::cout << (pr * pr) % MOD << '\n';
